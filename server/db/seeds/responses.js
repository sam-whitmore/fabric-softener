export async function seed(knex) {
  ...
  await knex('responses').insert([
    ...
    { id: 3, user_auth0_sub: 'google-oauth2|115733908984871137699', quant: 4938, qual: 'chalky', datetime: '2024-06-08T07:20:36.281Z', latitude: -41.2723, longitude: 174.7768, climate: 'clear', temp_C: 9 },
  ])
}
